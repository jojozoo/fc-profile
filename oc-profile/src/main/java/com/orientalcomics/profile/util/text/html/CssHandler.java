...
class CssHandler implements DocumentHandler {
     ...
     */
    public CssHandler(HtmlCorrectRule policy, LinkedList<URI> embeddedStyleSheets,
            ArrayList<String> errorMessages, ResourceBundle messages) {
     ...
     */
    public CssHandler(HtmlCorrectRule policy, LinkedList<URI> embeddedStyleSheets,
            ArrayList<String> errorMessages, String tagName, ResourceBundle messages) {
        this.policy = policy;
     ...
     * 
     * @see
     * org.w3c.css.sac.DocumentHandler#namespaceDeclaration(java.lang.String,
     * java.lang.String)
     */
     ...
     * 
     * @see
     * org.w3c.css.sac.DocumentHandler#endMedia(org.w3c.css.sac.SACMediaList)
     */
