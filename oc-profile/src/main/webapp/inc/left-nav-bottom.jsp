...
<div class="nav-box">
	<profile:security action="user_manage">
		<dl>
	...
	<profile:security action="perf_manage">
		<dl>
	...
	<profile:security action="view_promotees">
		<dl>
			<profile:menu prefix="admin_promotion">
				<a class="title" href="/admin/promotion">升级管理</a>
			</profile:menu>
			<profile:security action="view_history_promotees">
