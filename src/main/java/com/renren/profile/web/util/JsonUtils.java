...
public class JsonUtils {
    ...
    public static class Getter {
        ...
        public static Integer tryGetInteger(JSONObject obj, Integer valIfNull, Object key1, Object... keys) {
            return NumberUtils.toInt(tryGetString(obj, null, key1, keys), valIfNull);
        }
        ...
        public static Timestamp tryGetTimestamp(JSONObject obj, Timestamp valIfNull, Object key1, Object... keys) {
            return (Timestamp) ObjectUtils.defaultIfNull(TimeUtils.ParseTime.parse(tryGetString(obj, null, key1, keys)), valIfNull);
        }
    }
		...
		public JsonBuilder put(Object key, Object value) {
            if (value == null) {
                ...
                if (value instanceof String || //
                    ...
                    this.object.put(key, new ArrayList<Object>((Collection<?>) value));
                } else {
