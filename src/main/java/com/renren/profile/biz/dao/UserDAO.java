...
public interface UserDAO {
    ...
    String FIELD_PK          = "id";
    String FIELDS_WITHOUT_PK = "name,number,email,head_pic,status,pemission_level,job_title,level,show_level,department_id,manager_id";
    ...
    @SQL("insert ignore into "
            ...
            + " ("
            + FIELDS_WITHOUT_PK
            + ") VALUES (:model.name,:model.number,:model.email,:model.headPic,:model.status,:model.pemissionLevel,:model.jobTitle,:model.level,:model.showLevel,:model.departmentId,:model.managerId)")
    @ReturnGeneratedKeys
